...
func main() {
	...
	flag.StringVar(&path, "path", "./app.log", "read file path")
	flag.StringVar(&influxDsn, "influxDsn", "http://127.0.0.1:8086@root@root@NginxLogDB@s", "influx data source")
	flag.Parse()
